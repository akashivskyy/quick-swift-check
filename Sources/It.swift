...
public func sc_it(_ description: String, arguments: CheckerArguments? = nil, flags: FilterFlags = [:], file: FileString = #file, line: UInt = #line, _ closure: @escaping () -> Property) {
...
public func sc_fit(_ description: String, arguments: CheckerArguments? = nil, flags: FilterFlags = [:], file: FileString = #file, line: UInt = #line, _ closure: @escaping () -> Property) {
...
/// possible to write property tests inside Quick specs.
public func sc_xit(_ description: String, arguments: CheckerArguments? = nil, flags: FilterFlags = [:], file: FileString = #file, line: UInt = #line, _ closure: @escaping () -> Property) {
